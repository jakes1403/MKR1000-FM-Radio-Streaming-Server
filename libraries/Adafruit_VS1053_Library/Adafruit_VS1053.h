...
public:
  ...
  uint16_t loadPluginFromMemory(const uint8_t *plugin, size_t pluginSize);

  boolean prepareRecordOgg_plugin_from_memory(const uint8_t *plugin, size_t pluginSize);
